...
useEffect(()=>{  
  ...
  useEffect(()=>{
    const traerAtendiendoAhora=async()=>{
      ...
      setAtendidos(data.data().atencion.filter(turno=>turno.atencionUser===profileUser.userName))
    }
  ...
  return (
    <div className="flex-1 mx-auto  px-6 py-8 overflow-x-hidden overflow-y-auto">
      <h3 className="text-gray-700 text-xl font-medium">Nombre de la Ventanilla : <span  className="text-red-400 text-2xl font-bold">{ ventanillas? ventanillas[0]?.nombre : `---` }</span> </h3>
      <div className="mt-4">
        ...
        <div className="w-full mt-6 py-3 px-3 sm:w-1/2 xl:w-1/3 sm:mt-0">
            <div className="flex items-center bg-gray-200 bg-opacity-75 px-5 py-6 shadow-sm rounded-md bg-white">
              ...
              <div className="mx-5">
                <div className="text-gray-700 text-xl font-medium">Fila Asignada:</div>
          ...
          <div className="w-full mt-6 py-3 px-3 sm:w-1/2 xl:w-1/3 sm:mt-0">
            <div className="flex items-center bg-gray-200 bg-opacity-75 px-5 py-6 shadow-sm rounded-md bg-white">
              ...
              <div className="mx-5">
              <div className="text-gray-700 text-xl font-medium">Total Cola de Espera</div>
              {coladeEspera ?   
                <h4 className="text-2xl font-semibold text-gray-800">
                   📑  {coladeEspera?.length}
                </h4>
