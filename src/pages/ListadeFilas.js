  ...
  return (
    <div className="flex gap-2 ">
      ...
      <form action="" className="w-full ">
        ...
        className=" w-1/3 my-2 ml-1 bg-cyan-500 hover:bg-cyan-600 active:bg-cyan-700 focus:outline-none focus:ring focus:ring-cyan-300 rounded-lg p-2 text-white duration-300 font-bold">
          Crear Fila
        </button>
